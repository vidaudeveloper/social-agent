...
本技能已捆绑在 [social-agent](https://github.com/vidaudeveloper/social-agent) profile 中，路径为 `skills/social-media/xiaohongshu/`，通过 VidAU 安装 profile 后即可使用，**无需单独 clone 其他仓库**。
...
```bash
cd skills/social-media/xiaohongshu
uv sync
```
