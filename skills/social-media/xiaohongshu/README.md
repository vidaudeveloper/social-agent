...
> 📰 作者也在运营一个 AI 资讯网站 [![LLM大模型邮报 - 中文 AI 资讯快报：大模型动态、工程实践与行业观察](https://img.shields.io/badge/官网-llmposts.com-2563eb?style=flat-square&logo=googlenews&logoColor=white)](https://llmposts.com?utm_source=github&utm_medium=readme&utm_campaign=skills/xiaohongshu&utm_content=readme_intro "LLM大模型邮报 - 中文 AI 资讯快报：大模型动态、工程实践与行业观察") — 欢迎关注。
...
```
# OpenClaw 示例
<openclaw-project>/skills/skills/xiaohongshu/

# Claude Code 示例
<your-project>/.claude/skills/skills/xiaohongshu/
```
...
git clone https://github.com/autoclaw-cc/skills/xiaohongshu.git
```
...
[![Star History Chart](https://api.star-history.com/image?repos=autoclaw-cc/skills/xiaohongshu&type=date&legend=top-left)](https://www.star-history.com/?repos=autoclaw-cc%2Fskills/xiaohongshu&type=date&legend=top-left)
