...
| Node 封装 CLI | `node skills/youtube/scripts/cli.mjs` |
...
- CLI 契约：`skills/youtube/skills/youtube-upload/references/cli-contract.md`
- 运行前提：`skills/youtube/skills/youtube-upload/references/runtime-requirements.md`
