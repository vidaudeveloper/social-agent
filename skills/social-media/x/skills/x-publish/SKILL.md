...
node skills/x/scripts/cli.mjs publish --file "D:/test/hermes/文章/X/article.md"

# 视频帖
node skills/x/scripts/cli.mjs publish --text "Watch this" --video "D:/test/hermes/视频/clip.mp4"
```
