...
- 小红书**发之前**的竞品/热点：explore [`xhs-research`](../explore/xiaohongshu/xhs-research/)（`npm run xhs:research`）
- YouTube**发之前**的爆款调研：explore [`youtube`](../explore/youtube/)（`npm run youtube:explore`）
