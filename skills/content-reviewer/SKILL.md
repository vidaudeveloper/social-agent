...
metadata:
  hermes:
    ...
    related_skills:
      - social-media/pipeline-orchestrator
---
...
[`pipeline-orchestrator`](../social-media/pipeline-orchestrator/SKILL.md) 在 Step 4 与 Step 5 之间可选调用本技能（Step 4.5）。管线内仅引用技能名，**不重复**手册条文。
